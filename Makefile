...
$(PATHBIN)project_test: $(PATHBUILDTEST)main.o $(PATHBUILDTEST)test.o $(PATHBUILDTEST)print.o $(PATHBUILDTEST)file_search.o
	gcc -Wall $(PATHBUILDTEST)main.o $(PATHBUILDTEST)test.o $(PATHBUILDTEST)print.o $(PATHBUILDTEST)file_search.o -o $(PATHBIN)project_test
...
$(PATHBUILDTEST)print.o: $(PATHSRC)print.c $(PATHSRC)print.h
	gcc -Wall -Werror -c -I thirdparty -I src $(PATHSRC)print.c -o $(PATHBUILDTEST)print.o

$(PATHBUILDTEST)file_search.o: $(PATHSRC)file_search.c $(PATHSRC)file_search.h
